...
import { CircleDot, Mail, Lock, User, ArrowLeft, ArrowRight, Loader2, Zap, Shield, BarChart3, Users } from "lucide-react";
          ...
          >
            ...
            <Card className="border-0 shadow-2xl" style={{ backgroundColor: "#161b22" }}>
              <CardContent className="pt-8 pb-8 px-8">
                ...
                <p className={`text-muted-foreground text-sm mb-6 ${isRTL ? "text-right" : "text-left"}`}>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        className={`h-12 bg-background border-border ${isRTL ? "text-right" : ""}`}
                        style={{ backgroundColor: "#0d1117" }}
                  ...
                  >
                    {isLoading ? (
                      <>
                        ...
                        <span className="mr-2 ml-2">{t.auth.creatingAccount}</span>
                      </>
                    ) : (
